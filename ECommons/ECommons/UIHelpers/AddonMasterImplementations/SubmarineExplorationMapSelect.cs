...
{
    public unsafe class SubmarineExplorationMapSelect : AddonMasterBase<AtkUnitBase>
    {
        public SubmarineExplorationMapSelect(nint addon) : base(addon) { }
        public SubmarineExplorationMapSelect(void* addon) : base(addon) { }

        public SeString SeString => GenericHelpers.ReadSeString(&Base->GetTextNodeById(2)->NodeText);
        public string Text => SeString.GetText();

        public AtkComponentList* ListComponent => Addon->GetComponentListById(7);
        public int EntryCount => ListComponent->GetItemCount();
        ...
        public override string AddonDescription { get; } = "Submarine map selection menu";

        public struct Entry(SubmarineExplorationMapSelect am, AtkUnitBase* addon, int index)
        {
            ...
            public readonly SeString SeString => GenericHelpers.ReadSeString(&Addon->GetTextNodeById(2)->NodeText);
            ...
            {
                return $"AddonMaster.SubmarineExplorationMapSelect.Entry [Text=\"{Text}\", Index={Index}]";
            }
        }
