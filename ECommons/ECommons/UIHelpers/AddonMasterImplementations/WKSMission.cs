...
public partial class AddonMaster
{
    ...
    public unsafe partial class WKSMission : AddonMasterBase<AtkUnitBase>
    {
        ...
        public AtkComponentButton* MastershipMissionsButton => Addon->GetComponentButtonById(20);
        ...
        public void MastershipMissions() => ClickButtonIfEnabled(MastershipMissionsButton); // SelectedTab=3 マスターシップミッションタブ
    }
}
