...
namespace ICE.Ui.Debug_Tabs.Debug_Ui
{
    internal class Ui_PlayerInfo
    {
        ...
        public static unsafe void Draw()
        {
            ...
            ImGui.InputInt(Loc.T("Current XP"), ref currentXp);
            ImGui.SetNextItemWidth(200);
            ImGui.InputInt(Loc.T("Needed XP"), ref neededXp);
            ImGui.SetNextItemWidth(200);
            ImGui.InputInt(Loc.T("Max XP"), ref maxXp);
            ...
            if (ImGui.Button(Loc.T("Use Gathering Food")))
            {
                P.TaskManager.Enqueue(() => Task_Gather.UseFood());
            }
            if (ImGui.Button(Loc.T("Set all leveling missions")))
            {
            ...
            ImGui.SliderUInt(Loc.T("Player Level"), ref playerLevel, 10, 100);
            ...
            if (ImGui.CollapsingHeader(Loc.T("Test Picto")))
            {
            ...
            if (ImGui.Button(Loc.T("Use Drone")))
            {
                UseDrone();
            }
            if (ImGui.Button(Loc.T("Test Pathing to position")))
            {
            ...
            if (ImGui.Button(Loc.T("Cordial Test")))
            {
                UseCordial();
            }
        ...
        {
            ImGui.Text(Loc.T("Manipulation Check"));
        ...
        {
            if (ImGui.CollapsingHeader(Loc.T("Object info")))
            {
